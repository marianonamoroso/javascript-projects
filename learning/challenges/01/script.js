...
console.log(
  `DolphinsCounter: ${dolphinsCounter} \nKoalasCounter: ${koalasCounter} \nDolphins100: ${dolphinsHigherScoreCounter} \nKoalas100: ${koalasHigherScoreCounter}`
);
if (
  dolphinsCounter > koalasCounter &&
  dolphinsHigherScoreCounter > koalasHigherScoreCounter
) {
  console.log("The winner was Dolphins");
} else if (
  koalasCounter > dolphinsCounter &&
  koalasHigherScoreCounter > dolphinsHigherScoreCounter
) {
...
console.log(
  `The tip is: ${
    bill > 30 && bill < 300 ? (tip = bill * 0.15) : (tip = bill * 0.2)
  }`
);
console.log(
